		 ...
		 <div class="space-y-8 h-full">
		   ...
		   <div class="space-y-5 -mx-2">
			 ...
			 <div class="w-full flex items-end flex-wrap">
			   ...
			   <div class="w-full md:w-1/3 px-2 inputHolder">
				   <div class="input-label-holder">
					 <label class="input-titel">Alternative Mobile Number <b class="text-10">(Optional)</b></label>
					 <div class="input-checkd"><input type="checkbox" class="mr-2"/>Hidden</div>
				   </div>
				   <input type="text" class="input" required/>
			   </div>
			 ...
			 <div class="w-1/2 px-2">
			   <span class="input-titel">Price <b class="text-10">(If free value 0)</b></span>
			   <label for="" class="flex items-center w-full bg-white p-2 px-3.5 rounded-md">
				 <div class="w-full px-3.5">
				   <input type="text" class="w-full outline-none text-spiroDiscoBall font-bold text-base" value=""/>
				 </div>
