...
function PSBTermsAndConditions() {
              ...
              <div class="space-y-5">
                <div class="w-full space-y-2.5">
                  ...
                  <div class="w-full bg-white rounded">
                    <div class="p-8 w-full border-b-2 border-brightGray flex items-center space-x-6">
                      <div class="flex space-x-2.5">
                          <button type="button"><i class="icon-bold"></i></button>
                          <button type="button"><i class="icon-capitals"></i></button>
                          <button type="button"><i class="icon-underline"></i></button>
                          <button type="button"><i class="icon-italic"></i></button>
                      </div>
                      <div class="flex space-x-2.5">
                        <button type="button"><i class="icon-left-alignment"></i></button>
                        <button type="button"><i class="icon-center-alignment"></i></button>
                        <button type="button"><i class="icon-left-alignment-"></i></button>
                      </div>
                      <div class="flex space-x-2.5">
                        <button type="button"><i class="icon-list-alpha text-xl"></i></button>
                        <button type="button"><i class="icon-list text-xl"></i></button>
                        <button type="button"><i class="icon-list-num text-xl"></i></button>
                      </div>
                    </div>
                    <textarea cols="30" rows="10" class="w-full outline-none p-7 py-5"></textarea>
                  </div>
                </div>
                <div class="w-full">
                  <h3>Social Media</h3>
                    ...
                    <div class="w-full flex flex-wrap">
                      <div class="w-full md:w-1/2 p-2">
                        <div class="w-full p-3.5 bg-white rounded flex items-center space-x-4">
                          ...
                          <input type="text" class="w-full outline-none" placeholder="Enter URL"/>
                        </div>
                      </div>
                      <div class="w-full md:w-1/2 p-2">
                        <div class="w-full p-3.5 bg-white rounded flex items-center space-x-4">
