	...
	//   <!-- Content In -->
	  ...
	  <div className="wrapper min-h-full">
		...
		<div className="prw-next-btn">
		  ...
		  <button type="button" className="flex items-center active" onClick={() => navigate("/dashboard/event/termsandconditions")} ><h3>Next</h3><i className="icon-next-arrow ml-3"></i></button>
		</div>
