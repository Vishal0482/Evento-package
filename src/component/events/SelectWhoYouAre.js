  ...
  return (
    <div className="wrapper">
            ...
            <div className="flex flex-wrap justify-center pt-7 -mx-4">
              <div className="w-full sm:w-1/2 xl:w-1/3 px-2 xl:px-4 pb-4 xl:pb-0 group" onClick={() => navigate("event/places")}>
              ...
              <div className="w-full sm:w-1/2 xl:w-1/3 px-2 xl:px-4 pb-4 xl:pb-0 group" onClick={() => navigate("event/personal_skills")}>
                <a href="#" className="text-center bg-white rounded flex flex-col justify-between items-center h-full px-7 py-12 border-2 border-transparent group-hover:border-2 group-hover:border-spiroDiscoBall">
                  <div className="">
              ...
              <div className="w-full sm:w-1/2 xl:w-1/3 px-2 xl:px-4 pb-4 xl:pb-0 group" onClick={() => navigate("event/group_skills")}>
                <a href="#" className="text-center bg-white rounded flex flex-col justify-between items-center h-full px-7 py-12 border-2 border-transparent group-hover:border-2 group-hover:border-spiroDiscoBall">
                  <div className="">
