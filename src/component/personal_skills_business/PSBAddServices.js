	...
	<div class="wrapper min-h-full">            
	  <div class="space-y-8 h-full">
		...
		<div class="flex justify-between items-center">
		  ...
		  <button onClick={()=>setIsAddEquipmentPopUpOpen(true)} class="btn-primary small"><i class="icon-plus mr-3"></i>Add Equipment</button>
		</div>
		{/* <!-- step-progress-bar  --> */}
		...
		<div class="pt-5 space-y-3">
		  <div class="bg-white rounderd px-7 py-4 rounded-md">
			<div class="flex justify-between">
			  ...
			  <div class="w-full pl-5">
				...
				<p class="lg:max-w-[90%] text-quicksilver text-sm font-normal leading-6 pt-3">Lorem Ipsum is simply dummy text of the
