...
import { decrement, reset } from "../../redux/stepCountPogress";
...
function EventCalender() {
	...
	const handelEventDone = () => {
		navigater("/dashboard/event/:id")
		dispatch(reset());
	}
	return (
		// <!-- Content In -->
					...
					<div className="space-y-5">
						...
						<div className="calendar inline-block justify-center items-center rounded-md drop-shadow-one bg-white w-full px-12 py-7">
							...
							<div className="dates flex flex-wrap rounded-md overflow-hidden border border-gray-200">
								<div className="calender_number" style={{ color: "#b8b8b8b" }}>30</div>
								<div className="calender_number" style={{ color: "#b8b8b8b" }}>31</div>
								...
								<div className="calender_number">20</div>
								...
								<div className="calender_number" style={{ color: "#b8b8b8b" }}>2</div>
								<div className="calender_number" style={{ color: "#b8b8b8b" }}>3</div>
								<div className="calender_number" style={{ color: "#b8b8b8b" }}>4</div>
								<div className="calender_number" style={{ color: "#b8b8b8b" }}>5</div>
								<div className="calender_number" style={{ color: "#b8b8b8b" }}>6</div>
								<div className="calender_number" style={{ color: "#b8b8b8b" }}>7</div>
								<div className="calender_number" style={{ color: "#b8b8b8b" }}>8</div>
								<div className="calender_number" style={{ color: "#b8b8b8b" }}>9</div>
							</div>
						</div>
						{/* <!-- calendar end --> */}
						...
						<div className="prw-next-btn">
							...
							<button className="btn-primary" onClick={handelEventDone}>Done</button>
						</div>
					</div>
				</div>
			</div>
